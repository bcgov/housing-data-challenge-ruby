...
# 03. Load shape files ----
# Economic regions
shapes_dr_raw <- here::here("data_raw", "shapes", "2016", "ler_000a16a_e", "ler_000a16a_e.shp")
# Regional Districts
shapes_rd_raw <- here::here("data_raw", "shapes", "2016", "lcd_000a16a_e", "lcd_000a16a_e.shp")
# Municipaltities
shapes_mun_raw <- here::here("data_raw", "shapes", "2016", "lcsd000a16a_e", "lcsd000a16a_e.shp")
