...
The code for BC Housing Data Visualization Platform is open-sourced and publicly available
at BC Government [github repository](https://github.com/bcgov/housing-data-challenge-ruby).

## R packages
The platform is developed using R statistical software, and realized as R [Shiny™](http://shiny.rstudio.com/) app 
